    ...
    <section id="contact" className="contact">
      <div className="container">
        <div className="section-title">
          <h2>Հետադարձ կապ</h2>
          <p>
            aarba ընկերությունը զբաղվում է տրիցիկլների ներմուծմամբ և վաճառքով։
            ...
            չկա։ Տրիցիկլների բոլոր մոդելների համար aarba ընկերությունը
            տրամադրում է մեկ տարվա երաշխիք։ aarba սպասարկման կենտրոնը
            իրականացնում է նաև հետերաշխիքային սպասարկում և մարտկոցների ու այլ
            անհրաժեծտ սարքավորումների վաճառք։
          </p>
        </div>
      </div>
